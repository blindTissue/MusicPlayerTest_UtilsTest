...
//    }
    ...
    private void initializeTestDataForArtistDiff() throws Exception {
        ...
        testSongs.add(new Song(1, "a", "t", "b", Duration.ofSeconds(200), 1, 1,
                2020, LocalDateTime.now(), pathname));
        testSongs.add(new Song(2, "a", "ata", "b", Duration.ofSeconds(200), 2, 1,
                2020, LocalDateTime.now(), pathname2));
        testSongs.add(new Song(2, "a", "ta", "b", Duration.ofSeconds(200), 2, 1,
                2020, LocalDateTime.now(), pathname2));
        testSongs.add(new Song(3, "a", "at", "b", Duration.ofSeconds(200), 3, 1,
    ...
    private void initializeTestDataForAlbumDiff() throws Exception {
        ...
        testSongs.add(new Song(1, "a", "a", "t", Duration.ofSeconds(200), 1, 1,
                2020, LocalDateTime.now(), pathname));
        //testSongs.add(new Song(2, "a", "a", "ata", Duration.ofSeconds(200), 2, 1,
        //        2020, LocalDateTime.now(), pathname2));
        testSongs.add(new Song(2, "a", "a", "ta", Duration.ofSeconds(200), 2, 1,
                2020, LocalDateTime.now(), pathname2));
        testSongs.add(new Song(3, "a", "a", "at", Duration.ofSeconds(200), 3, 1,
        ...
        testSongs.add(new Song(3, "a", "a", " t", Duration.ofSeconds(200), 3, 1,
                2020, LocalDateTime.now(), pathname3));
        //testSongs.add(new Song(1, "a", "a", " ata", Duration.ofSeconds(200), 1, 1,
        //        2020, LocalDateTime.now(), pathname));
    ...
    void SongComparisonTest() throws InterruptedException {
        ...
        assertEquals(3, Search.getResult().getSongResults().size(), "Search should have 3 results.");
        assertEquals(0, Search.getResult().getAlbumResults().size(), "Search should have 0 album results.");
        assertEquals(0, Search.getResult().getArtistResults().size(), "Search should have 0 artist results.");
    }
    ...
    void ArtistComparisonTest() throws InterruptedException {
        ...
        // Check if the search results are as expected
        assertTrue(Search.hasResultsProperty().get(), "Search should have results.");
        assertEquals(0, Search.getResult().getSongResults().size(), "Search should have 0 song results.");
        assertEquals(0, Search.getResult().getAlbumResults().size(), "Search should have 0 album results.");
        assertEquals(3, Search.getResult().getArtistResults().size(), "Search should have 3 results.");
    }
    ...
    void AlbumComparisonTest() throws InterruptedException {
        ...
        // max return is 3.
        assertTrue(Search.hasResultsProperty().get(), "Search should have results.");
        assertEquals(3, Search.getResult().getAlbumResults().size(), "Search should have 3 results.");
        assertEquals(0, Search.getResult().getSongResults().size(), "Search should have 0 song results.");
        assertEquals(0, Search.getResult().getArtistResults().size(), "Search should have 0 artist results.");
    }

    @Test
    void SongComparisonTestA() throws InterruptedException {
        Resources.JAR = new File("src/test/resources").getAbsolutePath() + File.separator;
    ...
    @Test
    void ArtistComparisonTestA() throws InterruptedException {
        Resources.JAR = new File("src/test/resources").getAbsolutePath() + File.separator;
    ...
    @Test
    void AlbumComparisonTestA() throws InterruptedException {
        Resources.JAR = new File("src/test/resources").getAbsolutePath() + File.separator;
    ...
    // This test is finicky as it tests on breaking search loop when multiple searches are called.
    // The timing for this task worked for my computer. However, this test might fail if running on different hardware
    // or when initializing test.
    @Test
    void searchInterruptionTest() throws Exception {
        ...
        // Assert that the search thread is no longer alive
